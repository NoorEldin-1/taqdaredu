...
(function () {
  ...
  /* ---- TQ-CHAT-BOTTOM — المحادثة تفتح على آخر رسالة ------------------
     صار جسم المحادثة صندوقا يمرر داخله (`portal.css §٨`): يأخذ ارتفاع
     الشاشة وتمرر الرسائل فيه، فلا يبقى ثلث الصفحة أبيض ولا يهرب حقل
     الكتابة تحت الطية. وذلك يورث سؤالا لم يكن قائما: **من أين يبدأ
     العرض؟** الصندوق يفتح عند أعلاه — أي عند **أقدم** رسالة — فيقرأ من
     فتح محادثته آخر شيء قيل له قبل شهر، ولا يعرف أن تحته جديدا إلا أن
     يمرر. والصفحة قبل التغيير كانت تنتهي عند الأحدث بحكم طولها.

     ولا يستعمل `scrollIntoView`: هو يحرك **الصفحة** كذلك، فيقفز أعلاها
     ويغيب عنوانها. و`scrollTop` يحرك الصندوق وحده. */
  $$('[data-tq-chat-body], .tq-thread__body').forEach(function (box) {
