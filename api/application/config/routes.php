...
$route["sitemap.xml"] = "sitemap_seo";

// ==================== API v2 ROUTES ====================

// Admin API
$route['api/v2/admin/(:any)'] = 'api_admin/$1';
$route['api/v2/admin'] = 'api_admin';

// Notifications API
$route['api/v2/notifications/(:any)'] = 'api_notifications/$1';
$route['api/v2/notifications'] = 'api_notifications';

// Messages API
$route['api/v2/messages/(:any)'] = 'api_messages/$1';
$route['api/v2/messages'] = 'api_messages';

// Reports API
$route['api/v2/reports/(:any)/(:any)'] = 'api_reports/$1_$2';
$route['api/v2/reports/(:any)'] = 'api_reports/$1';
$route['api/v2/reports'] = 'api_reports';

// Webhooks API
$route['api/v2/webhooks/(:any)'] = 'api_webhooks/$1';
$route['api/v2/webhooks'] = 'api_webhooks';

// Payment API
$route['api/v2/payment/(:any)'] = 'api_payment/$1';
$route['api/v2/payment'] = 'api_payment';

// Courses API (Extended)

// Courses API - two-segment routes (method/id and method/id1/id2) must come before the generic one-segment catch-all below
$route['api/v2/courses/can_watch/(:any)/(:any)'] = 'api_courses/can_watch/$1/$2';
$route['api/v2/courses/(:any)/(:any)'] = 'api_courses/$1/$2';
$route['api/v2/courses/(:any)'] = 'api_courses/$1';
$route['api/v2/courses'] = 'api_courses';

// Frontend API (v2 alias)
$route['api/v2/(:any)'] = 'api_frontend/$1';
