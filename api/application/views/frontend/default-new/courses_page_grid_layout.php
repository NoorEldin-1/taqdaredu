                    ...
                    <a href="<?php echo site_url('home/course/' . rawurlencode(slugify($course['title'])) . '/' . $course['id']); ?>" class="eGridCourse epopCourse courses-card-body position-relative">
                        <div class="courses-card-image">
                            ...
                            <?php if ($course['status'] == 'upcoming'): ?>
                                <div class="upcoming-badge position-absolute" style="top: 10px; right: 10px; background: linear-gradient(135deg,rgb(77, 159, 236),rgb(61, 118, 243)); color: white; padding: 5px 12px; border-radius: 20px; font-size: 11px; font-weight: bold; box-shadow: 0 2px 8px rgba(212, 165, 116, 0.3); z-index: 10;">
                                    <i class="fa-regular fa-bell me-1"></i><?php echo get_phrase('Coming Soon'); ?>
                                </div>
                            <?php endif; ?>
                        </div>
                            ...
                            <div class="courses-price-border">
                                <div class="courses-price">
                                    <div class="courses-price-left">
                                        <?php if ($course['status'] == 'upcoming') : ?>
                                            <h5 class="upcoming-course-price" style="color:rgb(116, 190, 212); font-weight: bold;"><?php echo get_phrase('Upcoming'); ?></h5>
                                    ...
                                    <div class="courses-price-right ">
                                        <?php if ($course['status'] == 'upcoming'): ?>
                                            <?php if ($this->session->userdata('user_login')): ?>
                                                <span class="enrollBtn checkPropagation" style="background: linear-gradient(135deg,rgb(87, 154, 255),rgb(51, 190, 255)); cursor: pointer;" onclick="notifyForUpcoming('<?php echo $course['id']; ?>');"><i class="fa-regular fa-bell"></i> <?php echo get_phrase('Notify Me'); ?></span>
                                            <?php else: ?>
                                                <span class="enrollBtn checkPropagation" style="background: linear-gradient(135deg,rgb(116, 193, 212),rgb(51, 190, 255)); cursor: pointer;" onclick="redirectTo('<?php echo site_url('login'); ?>');"><i class="fa-regular fa-bell"></i> <?php echo get_phrase('Notify Me'); ?></span>
                                            <?php endif; ?>
                                        <?php elseif(is_purchased($course['id'])): ?>
