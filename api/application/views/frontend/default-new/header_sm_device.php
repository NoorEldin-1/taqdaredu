    ...
    <div class="offcanvas-body p-0">
      <div class="flex-shrink-0 mt-3">
        <ul class="list-unstyled ps-0">
          ...
          <!-- New Navigation Menu Items for Mobile -->
          <li class="bg-light">
            <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 text-dark text-16px fw-500 collapsed" data-bs-toggle="collapse" data-bs-target="#top-categories-collapse" aria-expanded="false">
              <i class="fas fa-th-large me-2"></i>
              <?php echo get_phrase('Top Categories'); ?>
            </button>
            <div class="collapse" id="top-categories-collapse">
              <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small bg-white pt-2">
                <?php
                $top_categories = $this->crud_model->get_categories('', 6)->result_array(); // Get top 6 categories
                foreach ($top_categories as $key => $category):?>
                <li>
                  <a href="<?php echo site_url('home/courses?category='.slugify($category['slug'])) ?>" class="btn btn-toggle-list d-inline-flex align-items-center rounded border-0 text-dark text-15px fw-400 py-2 w-100">
                    <span class="icons"><i class="<?php echo $category['font_awesome_class'] ?>"></i></span>
                    <span class="text-cat ms-2"><?php echo $category['name']; ?></span>
                  </a>
                </li>
                <?php endforeach; ?>
                <li>
                  <a href="<?php echo site_url('home/courses'); ?>" class="btn btn-toggle-list d-inline-flex align-items-center rounded border-0 text-dark text-15px fw-400 py-2 w-100">
                    <i class="fas fa-list me-2"></i> <?php echo get_phrase('View All Categories'); ?>
                  </a>
                </li>
              </ul>
            </div>
          ...
          <li class="bg-light">
            <a href="<?php echo site_url('home/become_an_instructor'); ?>" class="btn btn-toggle-list d-inline-flex align-items-center rounded border-0 text-dark text-16px fw-500">
              <i class="fas fa-chalkboard-teacher me-2"></i> <?php echo get_phrase('Become an instructor'); ?>
            </a>
          </li>
          ...
          <li class="bg-light">
            <a href="<?php echo site_url('home/contact_us'); ?>" class="btn btn-toggle-list d-inline-flex align-items-center rounded border-0 text-dark text-16px fw-500">
              <i class="fas fa-envelope me-2"></i> <?php echo get_phrase('Contact us'); ?>
            </a>
          </li>

          <li class="bg-light">
            <a href="<?php echo site_url('home/about_us'); ?>" class="btn btn-toggle-list d-inline-flex align-items-center rounded border-0 text-dark text-16px fw-500">
              <i class="fas fa-info-circle me-2"></i> <?php echo get_phrase('About us'); ?>
            </a>
          </li>
