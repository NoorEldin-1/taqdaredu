<div class="grid-view-body courses courses-list-view-body">
    ...
    <div class="courses-card courses-list-view-card">
        <?php foreach ($courses as $course) : ?>
            ...
            ?>
            <!-- Course List Card -->
            <a href="<?php echo site_url('home/course/' . rawurlencode(slugify($course['title'])) . '/' . $course['id']); ?>" class="courses-list-view-card-body courses-card-body  epopCourse eListCourse position-relative">
                <div class="courses-card-image ">
                    ...
                    <?php if ($course['status'] == 'upcoming'): ?>
                        <div class="upcoming-badge position-absolute" style="top: 10px; right: 10px; background:rgb(53, 164, 255); color: white; padding: 5px 10px; border-radius: 15px; font-size: 12px; font-weight: bold;">
                            <?php echo get_phrase('Coming Soon'); ?>
                        </div>
                    <?php endif; ?>
                    <!--  -->
                    ...
                    <div class="courses-price-border">
                        <div class="courses-price">
                            ...
                            <div class="courses-price-right gap-2 align-items-center">
                               ...
                               <?php if ($course['status'] == 'upcoming'): ?>
                                    <span class="enrollBtn" style="background: #6c757d; cursor: not-allowed;"><?php echo get_phrase('Coming Soon'); ?></span>
