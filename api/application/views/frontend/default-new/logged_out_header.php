            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="icon icon-left">
                        <ul class="nav">
                            <li class="nav-item px-2"><a href="#"><i class="fa-solid fa-phone"></i> +9029-500-024</a>
                            </li>
                            <div class="vartical"></div>
                            <li class="nav-item px-2"><a href="#"><i class="fa-solid fa-location-dot"></i> Melbourne,
                                    Australia</a></li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="menubar">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                ...
                <a class="navbar-brand logo" href="<?php echo site_url(''); ?>"><img loading="lazy"
                        src="<?php echo base_url('assets/frontend/default-new/image/logo.png') ?>" alt=""></a>
                ...
                <ul class="menu-offcanves">
                    ...
                    <li><a href="#mobile-primary-nav" class="btn-bar" type="button" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions"><i
                                class="fa-sharp fa-solid fa-bars"></i></a></li>
                </ul>
                    ...
                    <div class="antryArea ">
                        <ul class="antry-col d-flex align-items-center">
                            <?php if (addon_status('tutor_booking')): ?>
                                <li><a class="antry-link"
                                        href="<?php echo site_url('tutors'); ?>"><?php echo site_phrase('tutors'); ?></a>
                            ...
                            <?php if (addon_status('ebook')): ?>
                                <li><a class="antry-link"
                                        href="<?php echo site_url('ebook'); ?>"><?php echo site_phrase('ebooks'); ?>
                                    </a>
                                    <ul class="antry-submenu">
                        ...
                        <div class=" search-control">
                            <form action="<?php echo site_url('home/search'); ?>" method="POST">
                                ...
                                <input type="text" name='query'
                                    ...
                                    class="form-control" placeholder="<?php echo site_phrase('search_for_courses'); ?>">
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="right-menubar w-100">
                        ...
                        <ul class="sign-in-box">
                            ...
                            <?php foreach ($custom_page_menus->result_array() as $custom_page_menu): ?>
                                <li>
                                    <a class=" <?php if (isset($page_url) && $custom_page_menu['page_url'] == $page_url)
                                        echo 'active'; ?>"
                            ...
                            <?php if ($this->session->userdata('admin_login')): ?>
                                <li>
                                    <a
                                        href="<?php echo site_url('admin'); ?>"><?php echo site_phrase('administrator'); ?></a>
                                </li>
                            <?php endif; ?>
                            <li>
                                <div class="wisth_tgl_div d-flex align-items-center">
                                    <div class="wisth_tgl_2div ">
                                        <button class="menu_pro_cart_tgl bg-transparent border-0 p-0" type="button"
                                            aria-label="<?php echo get_phrase('Cart'); ?>"><i
                                                class="fa-solid fa-cart-shopping"></i>
                                            <p class="menu_number">1</p>
                                        </button>
                ...
                <form action="<?php echo site_url('home/search'); ?>" method="POST" class="inline-form">
                    <div class="mobile-search">
                        <button class="search-btn"><i class="fa-solid fa-magnifying-glass"></i></button>
                        <input type="text" name='query'
                            value="<?php echo isset($_GET['query']) ? $_GET['query'] : ""; ?>" class="form-control"
                    ...
                    <div class="offcanvas-header">
                        ...
                        <div class="offcanves-btn">
                            <a href="<?php echo site_url('sign_up'); ?>"
                                class="signUp-btn"><?php echo site_phrase('sign_up') ?></a>
                            <a href="<?php echo site_url('login'); ?>"
                                class="logIn-btn"><?php echo site_phrase('Login') ?></a>
                    ...
                    <div class="offcanvas-items">
                        <ul class="navbar-nav main-nav-wrap me-auto mb-2 mb-lg-0">
                            ...
                            foreach ($categories as $key => $category): ?>
                                <li class="nav-item">
                                    <a id="headerOne" class="nav-link header-dropdown" href="#">
                                        <?php echo site_phrase('courses'); ?> <i class="fa-solid fa-angle-right"></i>
                                    </a>
                                    <ul id="navOne" class="navbarHover">
                                        <li class="dropdown-submenu">
                                            <a href="#" id="showMenu-one">
                                                <span class="icons"><i
                                                        class="<?php echo $category['font_awesome_class']; ?>"></i></span>
                            ...
                            <?php endforeach; ?>
                            <li class="nav-item">
                                <a id="headerTwo" class="nav-link header-dropdown" href="#"> Ebook <i
