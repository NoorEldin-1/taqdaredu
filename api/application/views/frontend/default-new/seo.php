...
if (isset($page_name) && $page_name === 'home_1'):
    ...
    if (file_exists('uploads/system/' . $optimized_banner)) {
        $lcp_image_url = base_url('uploads/system/' . $optimized_banner);
    } else {
        $lcp_image_url = base_url('uploads/system/' . $banner_image);
    }
    ?>
    <!-- Preload LCP Image for faster rendering -->
    <link rel="preload" as="image" href="<?php echo $lcp_image_url; ?>" fetchpriority="high">
<?php endif; ?>