...
<main id="main-content" role="main">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12 order-2 order-lg-1">
                    <div class="h-1-banner-text EbannerLeft position-relative">
                        ...
                        <div class="EbannerTop  animate__animated  animate__fadeInUp opacityOnUp"
                            ...
                            <div class="search-option mb-0">
                                <form action="<?php echo site_url('home/search'); ?>" method="get">
                                    <input class="form-control" type="text"
                                        placeholder="<?php echo get_phrase('What do you want to learn'); ?>"
                                        name="query">
                                    <button class="submit-cls" type="submit"
                                        aria-label="<?php echo get_phrase('Search courses'); ?>">
                        ...
                        <div class="eCircle_parent">
                            <div class="eCircle  animate__animated  animate__fadeInRightBig" data-wow-duration="1000"
                                data-wow-delay="500">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12 order-md-2 order-1  order-lg-1 pt-0 pt-md-5 ">
                    <div class="EbannerRight">
                        <div class="Ebanner  animate__animated  animate__fadeInUp" data-wow-duration="1000"
                            data-wow-delay="500">
                            <?php
                            $banner_image = get_current_banner('banner_image');
                            $banner_name_parts = pathinfo($banner_image);
                            $optimized_banner = $banner_name_parts['filename'] . '_optimized.webp';
                            $mobile_banner = $banner_name_parts['filename'] . '_mobile.webp';

                            $banner_url = base_url("uploads/system/" . $banner_image); // Default
                            $srcset = "";

                            if (file_exists('uploads/system/' . $optimized_banner)) {
                                $banner_url = base_url("uploads/system/" . $optimized_banner);
                                $srcset .= $banner_url . ' 1920w';
                            }

                            if (file_exists('uploads/system/' . $mobile_banner)) {
                                $mobile_url = base_url("uploads/system/" . $mobile_banner);
                                if ($srcset != "")
                                    $srcset .= ", ";
                                $srcset .= $mobile_url . ' 600w';
                            }
                            ?>
                            <div style="display:none;">
                                <!-- Debug: Banner Image: <?php echo $banner_image; ?> -->
                                <!-- Debug: Optimized: <?php echo $optimized_banner; ?> (Exists: <?php echo file_exists('uploads/system/' . $optimized_banner) ? 'Yes' : 'No'; ?>) -->
                                <!-- Debug: Mobile: <?php echo $mobile_banner; ?> -->
                            </div>
                            <img loading="eager" fetchpriority="high" width="1920" height="769"
                                src="<?php echo $banner_url; ?>" <?php if ($srcset != "")
                                       echo 'srcset="' . $srcset . '" sizes="(max-width: 600px) 600px, 100vw"'; ?>
                                alt="<?php echo site_phrase(get_frontend_settings('banner_title')); ?>">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <img width="40" height="40"
                                        src="<?php echo base_url('assets/frontend/default-new/image/h1.svg') ?>"
                                        alt="<?php echo get_phrase('Expert instruction'); ?>">
                                </div>
                                <div class="col-lg-10">
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <img width="40" height="40" loading="lazy"
                                        ...
                                        alt="<?php echo get_phrase('Lifetime access'); ?>">
                                </div>
    ...
    <section class="download-app-wrapper py-5 wow animate__animated animate__fadeInUp" data-wow-duration="1000"
        data-wow-delay="300">
        <div class="container">
                    ...
                    <div class="download-app-box">
                        <div class="row align-items-center">
                            <div class="col-lg-7 col-md-7">
                                <div class="app-download-content text-center text-md-start">
                                    <h2 class="app-section-title mb-3">Download My Communication App</h2>
                                    <p class="app-section-subtitle mb-4">
                                        <?php echo site_phrase('Access our courses anytime, anywhere'); ?>
                                    </p>
                                    <div class="app-buttons-wrapper d-flex flex-wrap justify-content-center justify-content-md-start gap-3">
                                        <a href="#" class="app-download-btn android-btn" target="_blank">
                                            <img src="<?php echo base_url('assets/frontend/default-new/image/google-play_optimized.webp'); ?>"
                                                alt="Download on Google Play" class="app-store-image" width="200" height="60"
                                                loading="lazy">
                                        </a>
                                        <a href="#" class="app-download-btn ios-btn" target="_blank">
                                            <img src="<?php echo base_url('assets/frontend/default-new/image/app-store_optimized.webp'); ?>"
                                                alt="Download on App Store" class="app-store-image" width="200" height="60"
                                                loading="lazy">
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-5 col-md-5">
                                <div class="app-phone-mockup text-center">
                                    <img src="<?php echo base_url('assets/frontend/default-new/image/app-screenshot.webp'); ?>"
                                        alt="My Communication App preview" class="app-phone-image"
                                        width="460" height="980" loading="lazy">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <style>
        ...
        .download-app-box {
            background: linear-gradient(135deg, #667eea 0%, #0385ffff 100%);
            border-radius: 25px;
            padding: 50px 40px;
            position: relative;
            overflow: hidden;
        ...
        /* Decorative Elements */
        .download-app-box .app-download-content::before {
            content: '';
            position: absolute;
            top: -20px;
            right: -20px;
        ...
        .download-app-box .app-download-content::after {
            content: '';
            position: absolute;
            bottom: -30px;
            right: 50px;
        ...
        .download-app-box:hover .app-phone-image {
        ...
        .app-download-btn:hover .app-store-image {
    ...
    <section
        class="courses eTopcourse Ecourse grid-view-body pb-100 wow  animate__animated animate__fadeInUp opacityOnUp"
                ...
                <div class="course-group-slider" data-wow-duration="1000" data-wow-delay="500">
                    ...
                    <div class="single-popup-course epopCourse position-relative">
                        <a href="<?php echo site_url('home/course/' . rawurlencode(slugify($top_course['title'])) . '/' . $top_course['id']); ?>"
                            ...
                            <div class="courses-card-image">
                                ...
                                <div class="courses-icon <?php if (in_array($top_course['id'], $my_wishlist_items))
                                    ...
                                    <i class="fas fa-heart checkPropagation"
                                ...
                                <div class="review-icon">
                                    ...
                                    <div class="review-btn d-flex align-items-center">
                                        <span data-bs-toggle="tooltip"
                                            data-bs-title="<?php echo site_phrase('Compare') ?>"
                                            class="echecks checkPropagation"
                                        ...
                                        <div class="courses-price-right ">
                                            ...
                                            <span class="enrollBtn checkPropagation"
                                                onclick="redirectTo('<?php echo site_url('home/lesson/' . slugify($top_course['title']) . '/' . $top_course['id']) ?>');"><i
                                                    class="far fa-play-circle text-white"></i>
                                                <?php echo get_phrase('Start Now'); ?>
                                            </span>
                                            <?php else: ?>
                                            <span class="enrollBtn">
                                                <?php echo site_phrase('Enroll Now') ?>
                                            </span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                        ...
                        <div id="top_course_feature_<?php echo $top_course['id']; ?>" class="course-popover-content">
                            ...
                            <h6 class="text-white text-14px outCome">
                            ...
                            <div class="popover-btns">
                                ...
                                <button type="button" class="gift-btn ms-auto"
                                    title="<?php echo site_phrase('Gift someone else'); ?>" data-bs-toggle="tooltip"
                                ...
                                <!-- Cart button -->
                                                <button type="button" id="added_to_cart_btn_top_course<?php echo $top_course['id']; ?>"
                                                    class="purchase-btn align-items-center me-auto <?php if (!in_array($top_course['id'], $cart_items))
                                                        echo 'd-hidden'; ?>"
                                                ...
                                                <button type="button" id="add_to_cart_btn_top_course<?php echo $top_course['id']; ?>"
                                                    class="purchase-btn align-items-center me-auto <?php if (in_array($top_course['id'], $cart_items))
                                                        echo 'd-hidden'; ?>"
                                                    onclick="actionTo('<?php echo site_url('home/handle_cart_items/' . $top_course['id'] . '/top_course'); ?>'); ">
    ...
    <section class="top-categories pb-100 pt-0">
        <div class="container">
            ...
            <div class="category-product mt-2 wow  animate__animated animate__fadeInUp opacityOnUp"
                ...
                <div class="row justify-content-center">
                    <?php
                    // Get all categories instead of only top categories with courses
                    $all_categories = $this->db->limit(12)->get('category')->result_array();
                    foreach ($all_categories as $category):
                        // Count courses for each category
                        $course_count = $this->db->where('sub_category_id', $category['id'])->where('status', 'active')->from('course')->count_all_results();
                        ?>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-12 wow  animate__animated animate__fadeIn"
                        ...
                        <a href="<?php echo site_url('home/courses?category=' . $category['slug']); ?>"
                            class="category-product-body position-relative eCategory d-flex">
                            <?php
                            ...
                            <div class="cate-image">
                                <img width="96" height="96" loading="lazy"
                                    src="<?php echo base_url("uploads/thumbnails/category_thumbnails/" . $category['category_thumbnail']); ?>"
                            ...
                            <!-- <span class="category-hide-icon"><i class="fa-solid fa-angle-right"></i></span> -->
                                    <div class="eText">
                                        <h5 class="pt-0"> <?php echo $category['name']; ?></h5>
                                        <p class="hide-cat-text"><?php echo $course_count . ' ' . site_phrase('courses'); ?></p>
                                    </div>
                                </a>
                            </div>
                        <?php endforeach; ?>
    ...
    <!-- Start Upcoming Courses -->
        <?php $upcoming_courses = $this->db->order_by('id', 'desc')->limit(6)->get_where('course', ['status' => 'upcoming'])->result_array(); ?>
    ...
    <section
        ...
        <div class="container">
            <div class="cTitle text-center">
                <h1 class="pt-0 f-36">
                    <?php echo get_phrase('Explore our upcoming courses'); ?>
                </h1>
                <p>
                    <?php echo get_phrase('Discover a world of learning opportunities through our upcoming courses') ?>
                </p>
            </div>
            <div class="courses-card">
                <div class="course-group-slider" data-wow-duration="1000" data-wow-delay="500">
                    ...
                    foreach ($upcoming_courses as $upcoming_course):
                        ...
                        // For upcoming courses, we don't show ratings as they're not released yet
                        $total_rating = 0;
                        $number_of_ratings = 0;
                        $average_ceil_rating = 0;

                        // Use upcoming image if available, otherwise use regular thumbnail
                        $image_url = $upcoming_course['upcoming_image_thumbnail']
                            ? $this->crud_model->get_course_thumbnail_url($upcoming_course['id'])
                            : $this->crud_model->get_course_thumbnail_url($upcoming_course['id']);
                        ?>
                    <div class="single-popup-course epopCourse position-relative">
                        <a href="<?php echo site_url('home/course/' . rawurlencode(slugify($upcoming_course['title'])) . '/' . $upcoming_course['id']); ?>"
                            id="upcoming_course_<?php echo $upcoming_course['id']; ?>"
                            class="checkPropagation courses-card-body">
                            <div class="courses-card-image">
                                <img loading="lazy" width="300" height="200" src="<?php echo $image_url; ?>"
                                    alt="<?php echo $upcoming_course['title']; ?>">

                                <div class="courses-icon <?php if (in_array($upcoming_course['id'], $my_wishlist_items))
                                    echo 'red-heart'; ?>"
                                    id="coursesWishlistIconUpcomingCourse<?php echo $upcoming_course['id']; ?>">
                                    <i class="fas fa-heart checkPropagation"
                                        onclick="actionTo('<?php echo site_url('home/toggleWishlistItems/' . $upcoming_course['id'] . '/UpcomingCourse'); ?>')"></i>
                                </div>
                            ...
                            <div class="courses-text">
                                <h5 class="mb-2">
                                    <?php echo $upcoming_course['title']; ?>
                                </h5>
                                <div class="review-icon">
                                    <div class="review-icon-star align-items-center">
                                        <p>
                                        ...
                                        <p class="mr-5px">
                                            <?php if ($upcoming_course['publish_date'])
                                                echo date('M j, Y', strtotime($upcoming_course['publish_date'])); ?>
                                        </p>
                                        <p>(
                                            <?php echo get_phrase('Release Date') ?>)
                                        </p>
                                    </div>
                                    <div class="review-btn d-flex align-items-center">
                                        <span data-bs-toggle="tooltip"
                                            data-bs-title="<?php echo site_phrase('Compare') ?>"
                                            class="echecks checkPropagation"
                                            onclick="redirectTo('<?php echo base_url('home/compare?course-1=' . slugify($upcoming_course['title']) . '&course-id-1=' . $upcoming_course['id']); ?>');">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M13.6134 8.14665C13.3401 8.14665 13.1134 7.91998 13.1134 7.64665V5.43335C13.1134 4.60668 12.4401 3.93335 11.6134 3.93335H2.38672C2.11339 3.93335 1.88672 3.70668 1.88672 3.43335C1.88672 3.16002 2.11339 2.93335 2.38672 2.93335H11.6134C12.9934 2.93335 14.1134 4.05335 14.1134 5.43335V7.64665C14.1134 7.92665 13.8867 8.14665 13.6134 8.14665Z"
                                ...
                                <div class="courses-price-border">
                                    <div class="courses-price">
                                        ...
                                        <div class="courses-price-right ">
                                            <span class="enrollBtn upcoming-btn checkPropagation"
                                                onclick="notifyWhenAvailable(<?php echo $upcoming_course['id']; ?>)">
                                                <?php echo get_phrase('Notify Me') ?>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="upcoming_course_feature_<?php echo $upcoming_course['id']; ?>"
                            class="course-popover-content">
                            <p class="last-update">
                                <?php echo get_phrase('Release Date') . ': ' . ($upcoming_course['publish_date'] ? date('D, d-M-Y', strtotime($upcoming_course['publish_date'])) : get_phrase('Coming Soon')); ?>
                            </p>
                            <div class="course-title">
                                <a
                                    href="<?php echo site_url('home/course/' . rawurlencode(slugify($upcoming_course['title'])) . '/' . $upcoming_course['id']); ?>">
                                    <?php echo $upcoming_course['title']; ?>
                                </a>
                            </div>
                            <div class="course-meta">
                                <?php if ($upcoming_course['course_type'] == 'general'): ?>
                                <span class="">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <?php echo $this->crud_model->get_lessons('course', $upcoming_course['id'])->num_rows() . ' ' . site_phrase('lessons'); ?>
                                </span>
                                <?php if ($course_duration): ?>
                                <span class="">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                ...
                                <?php endif; ?>
                                <?php elseif ($upcoming_course['course_type'] == 'h5p'): ?>
                                <span class="badge bg-light">
                                    <?= site_phrase('h5p_course'); ?>
                                </span>
                                <?php elseif ($upcoming_course['course_type'] == 'scorm'): ?>
                                <span class="badge bg-light">
                                    <?= site_phrase('scorm_course'); ?>
                                </span>
                                <?php endif; ?>
                                <span class="">
                                    ...
                                    <?php echo ucfirst($upcoming_course['language']); ?>
                                </span>
                            </div>

                            <h6 class="text-white text-14px outCome">
                                <?php echo get_phrase('What you will learn') ?>:
                            </h6>
                            <ul class="will-learn">
                                <?php
                                $outcomes = json_decode($upcoming_course['outcomes']);
                                if ($outcomes):
                                    $count = 0;
                                    foreach ($outcomes as $outcome):
                                        $count++;
                                ...
                                <li class="outcome-item">
                                    <?php echo get_phrase('Course content will be available when released'); ?>
                                </li>
                                <?php endif; ?>
                            </ul>

                            <?php if ($outcomes && count($outcomes) > 3): ?>
                            <button class="view-more-btn">
                                <?php echo site_phrase('View More') ?>
                            </button>
                            <?php endif; ?>
                            ...
                            <div class="popover-btns">
                                <button type="button" class="purchase-btn upcoming-notify-btn ms-auto"
                                    onclick="notifyWhenAvailable(<?php echo $upcoming_course['id']; ?>)">
                                    <i class="fas fa-bell me-2"></i>
                                    <?php echo get_phrase('Notify Me'); ?>
                                </button>
                                <?php if ($upcoming_course['is_free_course'] != 1): ?>
                                <button type="button" class="gift-btn ms-auto"
                                    title="<?php echo get_phrase('Gift this upcoming course'); ?>"
                                    data-bs-toggle="tooltip"
                                    onclick="giftUpcomingCourse(<?php echo $upcoming_course['id']; ?>)"><i
                                        class="fas fa-gift"></i></button>
                                <?php endif; ?>
                            </div>
                            <script>
                                $(document).ready(function () {
                                    $('#upcoming_course_<?php echo $upcoming_course['id']; ?>').webuiPopover({
                                        url: '#upcoming_course_feature_<?php echo $upcoming_course['id']; ?>',
                                        trigger: 'hover',
                                        animation: 'pop',
                                        cache: false,
                                        multi: true,
    ...
    <section class="Ecourse courses grid-view-body pb-100 wow  animate__animated animate__fadeInUp opacityOnUp"
        data-wow-duration="500" data-wow-delay="300">
        <div class="container">
            ...
            <div class="courses-card">
                <div class="course-group-slider ">
                    ...
                    <div class="single-popup-course epopCourse position-relative">
                        <a href="<?php echo site_url('home/course/' . rawurlencode(slugify($latest_course['title'])) . '/' . $latest_course['id']); ?>"
                            ...
                            <div class="courses-card-image">
                                <img loading="lazy"
                                    ...
                                    alt="<?php echo $latest_course['title']; ?>">
                            ...
                            <div class="courses-text">
                                ...
                                <div class="review-icon">
                                    ...
                                    <div class="review-btn d-flex align-items-center">
                                        <span class="compare-img echecks checkPropagation" data-bs-toggle="tooltip"
                                            data-bs-title="<?php echo site_phrase('Compare') ?>"
                                ...
                                <div class="duration-time">
                                    <?php if ($course_duration): ?>
                                    <p class="m-0">
                                        <i class="fa-regular fa-clock p-0 text-15px"></i>
                                        <?php echo $course_duration; ?>
                                    </p>
                                    <?php endif; ?>
                                </div>
                        ...
                        <div id="latest_course_feature_<?php echo $latest_course['id']; ?>"
                            class="course-popover-content">
                            ...
                            <div class="popover-btns">
                                ...
                                <!-- Cart button -->
                                                <button type="button"
                                                    id="added_to_cart_btn_latest_course<?php echo $latest_course['id']; ?>" class="purchase-btn align-items-center me-auto <?php if (!in_array($latest_course['id'], $cart_items))
                                                           echo 'd-hidden'; ?>"
                                                    onclick="actionTo('<?php echo site_url('home/handle_cart_items/' . $latest_course['id'] . '/latest_course'); ?>');">
                                                    <i class="fas fa-minus me-2"></i> <?php echo get_phrase('Remove from cart'); ?>
                                                </button>
                                                <button type="button"
                                                    id="add_to_cart_btn_latest_course<?php echo $latest_course['id']; ?>" class="purchase-btn align-items-center me-auto <?php if (in_array($latest_course['id'], $cart_items))
                                                           echo 'd-hidden'; ?>"
                                                    onclick="actionTo('<?php echo site_url('home/handle_cart_items/' . $latest_course['id'] . '/latest_course'); ?>'); ">
                                                    <i class="fas fa-plus me-2"></i> <?php echo get_phrase('Add to cart'); ?>
                                                </button>
    ...
    <!---------  Expert Instructor Start ---------------->
        ...
        <?php if (count($top_instructor_ids) > 0): ?>
            <section
                class="expert-instructor eExpert-instruction top-categories pt-0 pb-100 wow  animate__animated animate__fadeInUp opacityOnUp"
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <p class="text-center mt-4 mb-30">
                        ...
                        <div class="row justify-content-center">
                            <?php foreach ($top_instructor_ids as $top_instructor_id):
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 eLink" data-wow-duration="1000" data-wow-delay="600">
                                    <a class="text-muted w-100 d-block"
                                        href="<?php echo site_url('home/instructor_page/' . $top_instructor['id']); ?>"
                                        aria-label="<?php echo get_phrase('View profile of') . ' ' . $top_instructor['first_name'] . ' ' . $top_instructor['last_name']; ?>">
                                        <div class="instructor-card-body nInstructor">
                                            <div class="instructor-card-img mb-0">
                                                <img src="<?php echo $this->user_model->get_user_image_url($top_instructor['id']); ?>"
                                                    alt="<?php echo $top_instructor['first_name'] . ' ' . $top_instructor['last_name']; ?>">
                                            </div>
        ...
        <section class="expert-instructor top-categories pb-100 pt-0 ">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 wow  animate__animated animate__fadeInUp opacityOnUp" data-wow-duration="1000"
                        data-wow-delay="500">
                        <h1 class="text-center f-36 mt-0 pt-0"><?php echo get_phrase('What the people Thinks About Us'); ?>
                        </h1>
                        <p class="text-center mt-4 mb-30">
                            <?php echo get_phrase('It highlights feedback and testimonials from users, reflecting their experiences and satisfaction.') ?>
                        </p>
                    </div>
                    <div class="col-lg-3"></div>
                </div>
                <div class="course-group-slider  wow  animate__animated animate__fadeInUp opacityOnUp"
                    data-wow-duration="1000" data-wow-delay="500">
                    <?php
                    ...
                    foreach ($reviews as $review):
                        ...
                        <div class="elegant-testimonial-slide">
                            <div class="ele-testimonial-profile-area d-flex">
                                <div class="profile">
                                    <img src="<?php echo $this->user_model->get_user_image_url($user_data['id']); ?>"
                                        alt="<?php echo $user_data['first_name'] . ' ' . $user_data['last_name']; ?>">
                                </div>
                                <div class="ele-testimonial-profile-name">
                                    <h6 class="name"><?php echo $user_data['first_name'] . ' ' . $user_data['last_name']; ?>
                                    </h6>
    ...
    <?php if (get_frontend_settings('faq_section') == 1): ?>
        ...
        <?php if (count($website_faqs) > 0): ?>
            ...
            <section class="faq eFaq top-categories pb-100 wow pt-0  animate__animated animate__fadeInUp opacityOnUp"
                data-wow-duration="1000" data-wow-delay="500">
                <div class="container">
                    <div class="row">
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="<?php echo 'faqItemHeading' . $key; ?>">
                                                <button class="accordion-button <?php if ($key != 0)
                                                    ...
                                                    aria-expanded="<?php echo $key != 0 ? 'false' : 'true'; ?>"
                                            ...
                                            <div id="<?php echo 'faqItempanel' . $key; ?>"
                                                ...
                                                aria-labelledby="<?php echo 'faqItemHeading' . $key; ?>"
    ...
    <section class="courses blog pb-100 wow  animate__animated animate__fadeInUp opacityOnUp" data-wow-duration="1000"
        data-wow-delay="500">
        <div class="container">
            <h1 class="text-center f-36 pt-0"><span>
                    <?php echo site_phrase('Visit our latest blogs') ?>
                </span></h1>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-3 wow  animate__animated animate__fadeIn" data-wow-duration="1000"
                        ...
                        <a href="<?php echo site_url('blog/details/' . slugify($latest_blog['title']) . '/' . $latest_blog['blog_id']); ?>"
                            class="courses-card-body blogCard">
                            <div class="courses-card-image">
                                    ...
                                    <div class="courses-price">
                                        <div class="courses-price-left">
                                            <img loading="lazy" class="rounded-circle"
                                                ...
                                                alt="<?php echo $user_details['first_name'] . ' ' . $user_details['last_name']; ?>">
    ...
    <script>
        // وظيفة Notify Me للدورات القادمة - تضيف الكورس للمفضلة والإشعارات
        function notifyWhenAvailable(courseId, event) {
            // منع انتشار الحدث مثل وظيفة checkPropagation
            if (event) {
    ...
    <?php endif; ?>
                ...
                // إضافة الكورس إلى المفضلة أولاً
                $.ajax({
                    url: '<?php echo site_url('home/toggleWishlistItems'); ?>/' + courseId + '/UpcomingCourse',
                    type: 'GET',
                    success: function (response) {
                        // تحديث أيقونة القلب
                        $('#coursesWishlistIconUpcomingCourse' + courseId).addClass('red-heart');

                        // إضافة الإشعار
                        $.ajax({
                            url: '<?php echo site_url('home/add_course_notification'); ?>',
                            type: 'POST',
                            data: {
                                course_id: courseId,
                    ...
                    success: function (notificationResponse) {
                        // عرض رسالة النجاح
                        toastr.success('<?php echo get_phrase('تم إضافة الكورس للمفضلة وسيتم إشعارك عند إصداره!'); ?>');

                        // تحديث الزر
                        $('span[onclick*="notifyWhenAvailable(' + courseId + ')"], a[onclick*="notifyWhenAvailable(' + courseId + ')"]').each(function () {
                            $(this).html('<i class="fas fa-heart me-2"></i> <?php echo get_phrase('Added to Favorites'); ?>');
                            $(this).removeClass('upcoming-notify-btn upcoming-btn').addClass('btn-success').attr('onclick', '');
                        });
                    },
                    error: function () {
                        // حتى لو فشل الإشعار، المفضلة نجحت
                        toastr.success('<?php echo get_phrase('تم إضافة الكورس للمفضلة بنجاح!'); ?>');
        ...
        error: function() {
            toastr.error('<?php echo get_phrase('حدث خطأ، يرجى المحاولة مرة أخرى'); ?>');
        }
    });
}
    </script>