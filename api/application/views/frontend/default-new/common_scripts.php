...
<?php if (!empty(get_settings('google_analytics_id'))): ?>
  <script async
    src="https://www.googletagmanager.com/gtag/js?id=<?php echo get_settings('google_analytics_id'); ?>"></script>
  <script>
...
<!-- Meta pixel - DEFERRED -->
<!-- Loads 4 seconds after page load to prevent blocking initial render -->
  ...
  <script>
    window.addEventListener('load', function () {
      setTimeout(function () {
        ...
        fbq('track', 'PageView');
      }, 4000); // Delay 4 seconds after page load
    });
  </script>
  <noscript>
