...
<nav class="navbar navbar-expand-lg navbar-light">
  <div class="container">
    ...
    <ul class="menu-offcanves">
      ...
      <li>
        <a href="#" class="btn-bar" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions"
          aria-controls="offcanvasWithBothOptions" aria-label="<?php echo get_phrase('Open navigation menu'); ?>"><i
    ...
    <div class="navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav main-nav-wrap mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link text-nowrap" href="#" id="navbarDropdownTopCategories">
            <span><?php echo get_phrase('Top Categories'); ?><i class="fas fa-angle-down ms-2"></i></span>
          </a>
          <ul class="navbarHover">
            <?php
            $top_categories = $this->crud_model->get_categories('', 6)->result_array(); // Get top 6 categories
            ...
            <li>
              <a href="<?php echo site_url('home/courses'); ?>">
                ...
                <?php echo get_phrase('View All Categories'); ?>
              </a>
            </li>
          </ul>
        </li>
      ...
      <ul class="navbar-nav main-nav-wrap mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link header-dropdown bg-white text-dark fw-600 text-nowrap"
            href="<?php echo site_url('home/become_an_instructor'); ?>" id="navbarDropdownInstructor">
            <span class=""><?php echo get_phrase('Become an instructor'); ?></span>
          </a>
        </li>
      </ul>
      ...
      <ul class="navbar-nav main-nav-wrap mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link header-dropdown bg-white text-dark fw-600 text-nowrap"
            href="<?php echo site_url('home/contact_us'); ?>" id="navbarDropdownContact">
            <span class=""><?php echo get_phrase('Contact us'); ?></span>
          </a>
        </li>
      </ul>
      ...
      <ul class="navbar-nav main-nav-wrap mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link header-dropdown bg-white text-dark fw-600 text-nowrap"
            href="<?php echo site_url('home/about_us'); ?>" id="navbarDropdownAbout">
            <span class=""><?php echo get_phrase('About us'); ?></span>
          </a>
        </li>
      </ul>
          ...
          <div class="header-search py-0 px-2 w-100">
            <div class="search-container w-100 me-3">
              <input id="headerSearchBarLg" name="query" type="text"
                ...
                value="<?php echo isset($_GET['query']) ? $_GET['query'] : ''; ?>">
              <button type="submit"
                class="header-search-icon border-0 text-dark text-16px <?php echo isset($_GET['query']) ? '' : 'd-hidden'; ?>">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M6.86992 8.1525C6.79492 8.145 6.70492 8.145 6.62242 8.1525C4.83742 8.0925 3.41992 6.63 3.41992 4.83C3.41992 2.9925 4.90492 1.5 6.74992 1.5C8.58742 1.5 10.0799 2.9925 10.0799 4.83C10.0724 6.63 8.65492 8.0925 6.86992 8.1525ZM8.625 2.06246C5.0025 2.06246 2.0625 5.00996 2.0625 8.62496C2.0625 12.24 5.0025 15.1875 8.625 15.1875C12.2475 15.1875 15.1875 12.24 15.1875 8.62496C15.1875 5.00996 12.2475 2.06246 8.625 2.06246Z"
                    fill="#0D0C23" />
                  <path
              ...
              <label for="headerSearchBarLg"
                class="header-search-icon text-dark text-16px <?php echo isset($_GET['query']) ? 'd-hidden' : ''; ?>">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M6.86992 8.1525C6.79492 8.145 6.70492 8.145 6.62242 8.1525C4.83742 8.0925 3.41992 6.63 3.41992 4.83C3.41992 2.9925 4.90492 1.5 6.74992 1.5C8.58742 1.5 10.0799 2.9925 10.0799 4.83C10.0724 6.63 8.65492 8.0925 6.86992 8.1525ZM8.625 2.06246C5.0025 2.06246 2.0625 5.00996 2.0625 8.62496C2.0625 12.24 5.0025 15.1875 8.625 15.1875C12.2475 15.1875 15.1875 12.24 15.1875 8.62496C15.1875 5.00996 12.2475 2.06246 8.625 2.06246Z"
                    fill="#0D0C23" />
      ...
      <div class="right-menubar ms-auto ">
        ...
        <div class="wisth_tgl_div">
          <div class="wisth_tgl_2div">
            <button type="button" class="menu_pro_cart_tgl mt-1 border-0 bg-transparent p-0"
              aria-label="<?php echo get_phrase('Cart'); ?>">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <?php if (!$user_id): ?>
          ...
          <?php if (get_settings('public_signup') == 'enable'): ?>
            <a href="<?php echo site_url('sign_up'); ?>" class="ms-3 text-capitalize ctBtn" style="min-width: 70px">
                    ...
                    <li class="user-dropdown-menu-item"><a href="<?php echo site_url('home/my_messages'); ?>">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                            ...
                            stroke="#99A1B7" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round"
                            stroke-linejoin="round" />
                          <path d="M12.75 6.75L10.4025 8.625C10.296 8.20625 10.296 7.75 10.4025 7.375L12.75 6.75"
                            stroke="#99A1B7" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round"
                            stroke-linejoin="round" />
                        </svg>
