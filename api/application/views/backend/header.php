    ...
    <div class="container-fluid">
        ...
        <a href="<?php echo site_url($this->session->userdata('role')); ?>" class="topnav-logo" style="min-width: unset;">
            <span class="topnav-logo-lg">
                <img src="<?php echo base_url('uploads/system/' . get_frontend_settings('small_logo')); ?>" alt="<?php echo html_escape($system_name); ?>" height="34">
            </span>
            <span class="topnav-logo-sm">
                <img src="<?php echo base_url('uploads/system/' . get_frontend_settings('small_logo')); ?>" alt="<?php echo html_escape($system_name); ?>" height="34">
            </span>
            <?php // The wordmark is set as live text rather than baked into the logo
                  // image: scaled to a 40px bar the word inside the full vertical
                  // lockup would be ~9px tall. As text it stays crisp and picks up
                  // Tajawal, which the panel already loads. ?>
            <span class="topnav-logo-text"><?php echo html_escape($system_name); ?></span>
        </a>
        ...
        <div class="visit_website">
            <?php // The site name used to be repeated here as a floated <h4>, which
                  // left the bar carrying the brand twice. It now sits once, in the
                  // logo lockup at the start of the bar. ?>
            <a href="<?php echo site_url('home'); ?>" target="" class="btn btn-outline-light d-none d-md-inline-block"><?php echo get_phrase('visit_website'); ?></a>
        </div>
    </div>
</div>
<!-- end Topbar -->
