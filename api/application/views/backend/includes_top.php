...
<!-- Tagdar brand overlay + RTL. MUST stay last so it wins over the vendor
     theme (app.min.css / main.css). See the file header for what it covers. -->
<link href="<?php echo base_url('assets/backend/css/tagdar.css') ?>?v=12" rel="stylesheet" type="text/css" />
