...
<!-- Arabic strings for the Summernote editor's own toolbar and dialogs. Must sit
     AFTER the editor core and BEFORE anything initialises an editor. -->
<script src="<?php echo base_url('assets/backend/js/vendor/summernote-ar-AR.min.js'); ?>"></script>
<script src="<?php echo base_url('assets/backend/js/tagdar-summernote-ar.js'); ?>?v=1"></script>
...
<!-- Arabic strings for DataTables' own chrome. Must sit AFTER the DataTables
     core and BEFORE the initialiser, so the defaults are in place when tables
     are constructed. -->
<script src="<?php echo base_url('assets/backend/js/tagdar-datatables-ar.js'); ?>?v=1"></script>
