                    ...
                    <table id="basic-datatable" class="table table-striped table-centered mb-0">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo get_phrase('applies_to_course'); ?></th>
                        ...
                        <tbody>
                            ...
                            foreach ($coupons as $key => $coupon) :
                                $restricted_course = !empty($coupon['course_id']) ? $this->crud_model->get_course_by_id($coupon['course_id'])->row_array() : null;
                            ?>
                                <tr>
                                    <td><?php echo $key + 1; ?></td>
                                    <td><strong><?php echo $coupon['code']; ?></strong></td>
                                    <td><?php echo $coupon['discount_percentage']; ?>%</td>
                                    <td><?php echo $restricted_course ? $restricted_course['title'] : get_phrase('all_courses_store_wide'); ?></td>
