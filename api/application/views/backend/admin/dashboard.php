    ...
    <div class="col-xl-4">
        <div class="card">
            <div class="card-body">
                ...
                <?php // With no courses yet the doughnut draws nothing, leaving a 202px void. ?>
                <?php if ($number_of_courses > 0): ?>
                <div class="my-4 chartjs-chart" style="height: 202px;">
                    <canvas id="project-status-chart"></canvas>
                </div>
                <?php else: ?>
                <div class="my-4 tg-empty" style="height: 202px;">
                    <i class="dripicons-archive"></i>
                    <strong><?php echo get_phrase('no_courses_yet'); ?></strong>
                    <span><?php echo get_phrase('add_your_first_course_to_see_it_here'); ?></span>
                    <a href="<?php echo site_url('admin/course_form/add_course'); ?>" class="btn btn-primary btn-sm mt-2"><?php echo get_phrase('add_new_course'); ?></a>
                </div>
                <?php endif; ?>
                ...
                <div class="table-responsive">
                    <table class="table table-centered table-hover mb-0">
                        <tbody>
                            ...
                            ?>
                            <?php if (count($pending_payouts) < 1): ?>
                            <tr>
                                <td colspan="2" class="border-0">
                                    <div class="tg-empty">
                                        <i class="mdi mdi-cash-check"></i>
                                        <strong><?php echo get_phrase('no_withdrawal_requests'); ?></strong>
                                        <span><?php echo get_phrase('withdrawal_requests_from_instructors_will_appear_here'); ?></span>
                                    </div>
                                </td>
                            </tr>
                            <?php endif; ?>
