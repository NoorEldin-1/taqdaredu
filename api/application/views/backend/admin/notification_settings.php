                                ...
                                <tbody>
                                    <?php foreach ($notify_settings as $key => $notification_row) :?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php foreach((array) json_decode($notification_row['subject'], true) as $user_type => $subject): ?>
                                                    <p><?php echo get_phrase('To '.$user_type); ?>: <?php echo $subject; ?></p>
                                                <?php endforeach; ?>
                                            </td>
                                            <td>
                                                <?php foreach((array) json_decode($notification_row['template'], true) as $user_type => $template): ?>
                            ...
                            <div class="col-md-12">
                                ...
                                foreach($notify_settings as $row):
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <?php foreach((array) json_decode($row['user_types'], true) as $user_type): ?>
                                            <div class="col-auto">
