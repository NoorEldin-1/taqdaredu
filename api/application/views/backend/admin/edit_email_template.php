<form action="<?php echo site_url('admin/edit_email_template/'.$notification['id'].'/update'); ?>" method="post">
	<?php foreach((array) json_decode($notification['subject'], true) as $user_type => $subject): ?>
	...
	<?php foreach((array) json_decode($notification['template'], true) as $user_type => $template): ?>
		<div class="form-group">
