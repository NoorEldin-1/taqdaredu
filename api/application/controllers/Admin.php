...
class Admin extends CI_Controller
{
    ...
    {
        check_permission('settings'); // A4 fix
    ...
    {
        check_permission('course'); // A4 fix
        $data = array();
        //mentioned all with colum of database table that related with html table
    ...
    {
        check_permission('category'); // A4 fix
    ...
    public function export_enrol_history_csv() {
        check_permission('enrolment'); // A4 fix
