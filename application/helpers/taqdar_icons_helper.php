...
if (!function_exists('tq_icon')) {
    function tq_icon($name, $size = 20)
    {
        static $paths = [
            ...
            /* ترس بأسنان لا دائرة بأشعة: الرسم القديم كان يقرأ شمسا («الوضع
               الفاتح») لا إعدادات. */
            'cog'         => '<path d="M12.2 2h-.4a2 2 0 0 0-2 2v.2a2 2 0 0 1-1 1.7l-.4.3a2 2 0 0 1-2 0l-.2-.1a2 2 0 0 0-2.7.7l-.2.4a2 2 0 0 0 .7 2.7l.2.1a2 2 0 0 1 1 1.7v.5a2 2 0 0 1-1 1.7l-.2.1a2 2 0 0 0-.7 2.7l.2.4a2 2 0 0 0 2.7.7l.2-.1a2 2 0 0 1 2 0l.4.3a2 2 0 0 1 1 1.7v.2a2 2 0 0 0 2 2h.4a2 2 0 0 0 2-2v-.2a2 2 0 0 1 1-1.7l.4-.3a2 2 0 0 1 2 0l.2.1a2 2 0 0 0 2.7-.7l.2-.4a2 2 0 0 0-.7-2.7l-.2-.1a2 2 0 0 1-1-1.7v-.5a2 2 0 0 1 1-1.7l.2-.1a2 2 0 0 0 .7-2.7l-.2-.4a2 2 0 0 0-2.7-.7l-.2.1a2 2 0 0 1-2 0l-.4-.3a2 2 0 0 1-1-1.7V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/>',
            ...
            /* ثلاث نقاط رأسية — زر «إجراءات الصف». وهي مصمتة لا مفرغة:
               دائرة بقطر ثلاث بكسلات مرسومة بالخط تقرأ حلقة لا نقطة.
               و`stroke:none` عليها صراحة لأن الوسم الخارجي يعلن خطا. */
            'dots'        => '<circle cx="12" cy="5" r="1.7" fill="currentColor" stroke="none"/>'
                           . '<circle cx="12" cy="12" r="1.7" fill="currentColor" stroke="none"/>'
                           . '<circle cx="12" cy="19" r="1.7" fill="currentColor" stroke="none"/>',
            /* سهم لأسفل — المنتقي والقائمة المنسدلة. وهو **غير اتجاهي**:
               «أسفل» أسفل في اللغتين، فلا يدخل في قائمة الانعكاس. */
            'chev-down'   => '<path d="m6 9.5 6 6 6-6"/>',
            /* واتساب — رسم بالخطوط لا بالمصمت، كسائر أيقونات هذه المجموعة:
               فقاعة بذيل في زاويتها السفلى وسماعة داخلها. والشعار الرسمي
               مصمت وبلونه، وهو لا يصلح هنا: الأيقونة ترث لون سياقها
               (currentColor)، فشعار بلون ثابت يشذ في كل حال. */
            'whatsapp'    => '<path d="M20 11.5a8 8 0 0 1-11.9 7L4 20l1.6-4A8 8 0 1 1 20 11.5z"/>'
                           . '<path d="M9.2 8.6c.3-.1.6 0 .8.3l.7 1.2c.1.3.1.6-.1.8l-.4.5c-.1.2-.2.4 0 .6.5.9 1.2 1.6 2.1 2.1.2.1.4.1.6-.1l.5-.4c.2-.2.5-.2.8-.1l1.2.7c.3.2.4.5.3.8-.2.7-.9 1.2-1.7 1.1-2.7-.3-5-2.6-5.3-5.3-.1-.8.4-1.5 1.1-1.7z"/>',

            /* واتساب — رسم بالخطوط لا بالمصمت، كسائر أيقونات هذه المجموعة:
               فقاعة بذيل في زاويتها السفلى وسماعة داخلها. والشعار الرسمي
               مصمت وبلونه، وهو لا يصلح هنا: الأيقونة ترث لون سياقها
               ()، فشعار بلون ثابت يشذ في كل حال. */
        ];
