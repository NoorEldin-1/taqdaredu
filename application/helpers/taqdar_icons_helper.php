...
/**
 * أيقونات تقدّر — SVG مضمَّن، بلا حزمة أيقونات وبلا جلب من الشبكة.
 * كلّها مرسومة بـ currentColor فترث لون السياق، ومعلَّمة aria-hidden لأن
 * المعنى يحمله النصّ المجاور لا الأيقونة — واللون وحده لا يحمل معنى.
 *
...
if (!function_exists('tq_icon')) {
    function tq_icon($name, $size = 20)
    {
        static $paths = [
            ...
            // اتجاهيّتان: تُرسمان بمنطق LTR وتنعكسان في RTL عبر .tq-dir-icon
