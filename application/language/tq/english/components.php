...
return array(
    ...
    'اربط' => 'Map',
    'افصل' => 'Unlink',
    'الحسابات المرتبطة' => 'Linked accounts',
    ...
    'بريد مخفي من أبل — رسائلنا تصلك عليه ويحولها إلى بريدك الحقيقي.' => 'A hidden Apple address - our mail reaches you there and Apple forwards it to your real inbox.',
    ...
    'حسابات تدخل بها إلى تقدر بنقرة واحدة بدل كلمة المرور.' => 'Accounts that sign you in to Taqdar with one tap instead of a password.',
    ...
    'ضع كلمة مرور من هنا' => 'Set a password here',
    'غير مرتبط' => 'Not linked',
    'لا كلمة مرور على حسابك بعد — دخولك بهذه الحسابات وحدها.' => 'Your account has no password yet - these accounts are your only way in.',
    'لا نتائج بعد.' => 'No results yet.',
    'لتفتح لك بابا ثانيا.' => 'to give yourself a second way in.',
