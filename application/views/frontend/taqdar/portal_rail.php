...
$tq_rail_map = [
    ...
    'teacher' => [
        ...
        [t('التدريس'), [
            ...
            /* TQ-BOOK — والكتاب محتوى معلم كما الدرس، وموضعه بعد الرفع
               لأنه من الجنس نفسه: شيء يؤلفه ثم يرسله للمراجعة. وكان
               يؤلفه ويرسله بالبريد ليضعه المسؤول بيده، أو لا يصل. */
            ['books',     t('كتبي'),            'teacher/books',     'book'],
...
$tq_count_sr = [
    /* الشرط `due_at <= NOW()` يبلع كل متأخر من أيام مضت، لا اليوم وحده. */
    'reviews'       => t('سؤال مستحق'),
    'tasks'         => t('مهمة مستحقة'),
