...
<div class="tq-lesson" data-tq-lesson="<?php echo $tq_lesson_id; ?>"
    ...
    <div class="tq-cols" data-tq-lesson-body hidden>
        <div class="tq-stack">
            ...
            <?php /* ── حين يتعذر القياس ───────────────────────────────
                     حالتان لا واحدة، والنص يفرق بينهما من جافاسكربت:

                     ١ — **مصدر لا يقاس أصلا**: درايف والإطار الخارجي لا
                         يعطيان موضع تشغيل ولا مدة. معروف من أول لحظة.
                     ٢ — **مصدر يفترض أنه يقاس ولم يقس**: سكربت يوتيوب
                         يحجب في شبكة مدرسة، والفيديو يحذف من مصدره،
                         والتضمين يرفض. وهنا لا شيء يقع: لا موضع ولا مدة
                         ولا رسالة خطأ — شاشة صامتة وشريط لا يتحرك ودرس
                         تال مقفل إلى الأبد. وكان هذا هو الحال.

                     والبديلان في الحالتين: حبس لا نهاية له، أو إقرار
                     يعلنه الطالب. والثاني إقرار لا قياس — يقال له ذلك
                     صراحة، ويسجل في `declared_at` فيعرف معلمه الفرق.
                     وشريط تقدم يتحرك بمؤقت على شيء قد يكون أوقفه كذب
                     أسوأ من الصمت. */ ?>
