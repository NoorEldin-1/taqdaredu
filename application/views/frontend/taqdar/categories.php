 ...
 * الأقسام.
 *
 * كانت تعدّ **دورات Academy** بشرط `status='active'` — وفي القاعدة دورة
 * واحدة بلا قسم، فتقول كل قسم «صفر دورة» بينما الكتالوج يعرض خمسة عشر
 * برنامجًا. كيانان مختلفان يُعدّان في صفحتين، لا بيانات غير متزامنة.
 *
 * وروابطها كانت تُصدر `?category=` والكتالوج يقرأ `?cat=` — فالضغط على
 * أي قسم يفتح كل المواد. و`tqs_category_links()` تبني الرابط الصحيح.
 */
$tq_h1   = 'الأقسام';
$tq_lead = 'اختر المرحلة أو المجال، فتصل إلى برامجه مباشرةً.';
...
<section class="section">
  <div class="shell">
    ...
    <?php else: ?>
      <p class="dir-empty">لم تُضَف أقسام بعد.</p>
    <?php endif; ?>
  </div>
</section>
