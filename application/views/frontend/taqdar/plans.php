...
$tq_lead = tq_text_raw('plans', 'hero_lede', 'اختر باقة للمحتوى المنشور في مرحلتك، وراجع المواد والدروس الجاهزة قبل الدفع. الشهري يفتح 30 يوما والسنوي 365 يوما، دون تجديد تلقائي.');
...
<?php /* مسارات التأسيس — آخر الصفحة: من قرأ الباقات والفرق بينها ولم
        يجد ما يريده (لأنه لا يريد منهج صف أصلا) يجد هنا الباب الآخر.
        والمولد نفسه الذي في الرئيسية. */ ?>
