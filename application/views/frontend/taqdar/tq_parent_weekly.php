    ...
    <div>
        <?php if ($tq_children): ?>
            ...
            <?php foreach ($tq_children as $tq_c): ?>
                ...
                $tq_lines[] = ['✅',
                    'أكمل ' . $tq_c['done'] . ' دروس · سلم ' . $tq_c['quizzes'] . ' اختبارا هذا الأسبوع'];

                $tq_lines[] = ['📈',
                    $tq_c['days_this'] > $tq_c['days_prev']
                        ? 'نشاطه ارتفع من ' . $tq_c['days_prev'] . ' أيام إلى ' . $tq_c['days_this'] . ' أيام مقارنة بأسبوعه الماضي'
                        : ($tq_c['days_this'] < $tq_c['days_prev']
                            ? 'نشاطه نزل من ' . $tq_c['days_prev'] . ' أيام إلى ' . $tq_c['days_this'] . ' أيام مقارنة بأسبوعه الماضي'
