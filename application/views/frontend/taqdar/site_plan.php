          ...
          <ul class="tlist">
            <?php foreach ($b['teachers'] as $tt): ?>
              ...
              $tt_b   = '<span class="tlist__b"><b>' . html_escape($tt['name']) . '</b>'
                      . '<small>' . strip_tags(tqs_ar_count((int) $tt['n'], array('برنامج واحد', 'برنامجان', 'برامج', 'برنامجا'))) . ' في هذه الباقة</small></span>';
              ?>
        ...
        <div class="faq2">
          ...
          $faq = array(
            ...
            array('هل يمكن أن أعاين قبل أن أدفع؟',
                  $t['free'] > 0
                    ? 'نعم — ' . strip_tags(tqs_ar_count((int) $t['free'], array('درس واحد', 'درسان', 'دروس', 'درسا'))) . ' في هذه الباقة للمعاينة، تجدها بعلامة «معاينة مجانية» في المنهج أعلاه.'
