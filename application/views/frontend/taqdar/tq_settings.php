            ...
            <div class="tq-stack">
                ...
                <?php elseif ($active === 'alerts'): ?>
                    <section class="tq-card">
                        ...
                        <p class="tq-caption">
                            <?php /* TQ-CHANNEL-COUNT — «قناتان» كانت مكتوبة بالحرف، وأعمدة الجدول
                                     تبنى من `notify_channels()` التي تضيف واتساب متى كان مضبوطا
                                     على المنصة. فعلى الإنتاج ثلاثة أعمدة ونص يعد باثنين: الطالب
                                     يقرأ أن له قناتين وأمامه خمسة عشر مربعا في ثلاثة أعمدة. */ ?>
                            <?php $tq_nch = count($tq_channels); ?>
                            <?php echo $tq_nch === 2
                                ? t('لكل نوع قناتان مستقلتان — إيقاف قناة لا يوقف الأخرى.')
                                : t('لكل نوع ____ قنوات مستقلة — إيقاف قناة لا يوقف غيرها.', array($tq_nch)); ?>
                            <?php echo t('وليست هناك قناة «إشعار على الجهاز» لأن المنصة لا ترسل إشعارات دفع بعد.'); ?>
                        </p>
