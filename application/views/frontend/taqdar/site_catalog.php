 ...
 * ═══ لماذا صفحة واحدة ═══
 *
 * كان المحتوى موزعا على ثلاثة أبواب: البرامج تحت `/plans`، والكتب تحت
 * `/books`، والمسابقات تحت `/competitions`. ومن يبحث عن «رياضيات الصف
 * الرابع» لا يعرف أي باب يطرق، ولا مرشح في باب يشبه مرشح الآخر: هنا
 * أزرار فئات، وهناك تبويب مراحل، وفي الثالث لا شيء.
 *
...
$tq_lead = tq_text_raw('site_catalog', 'hero_lede',
    'كل ما تقدمه تقدر في مكان واحد: باقات المراحل وبرامج المواد وكتب المنهج والمسابقات — ابحث ورشح حتى تصل إلى ما يخص صفك.');
