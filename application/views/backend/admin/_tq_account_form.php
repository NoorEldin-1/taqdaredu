...
<form action="<?php echo $tq_action; ?>" method="post" enctype="multipart/form-data"
        ...
        <div class="tqa-fieldgrid">
            ...
            <?php if ($tq_skills): ?>
                <div class="tqa-field tqa-field--full">
                    ...
                    <span class="tqa-field__hint">يظهر تحت اسم المعلم في صفحته العامة.</span>
                </div>
            ...
            <div class="tqa-field tqa-field--full">
                ...
                <div class="tqa-file">
                    <?php if ($tq_row): ?>
                        <img class="tqa-avatar" width="38" height="38" alt="الصورة الحالية"
                    ...
                    <label class="tqa-file__btn" for="user_image">
                        ...
                        <?php echo $tq_row ? 'استبدل الصورة' : 'اختر صورة'; ?>
                    </label>
                    <span class="tqa-file__name" data-tqa-file-name>
                        <?php echo $tq_row ? 'اتركه فارغا لإبقاء الصورة الحالية' : 'صورة مربعة تخرج أفضل'; ?>
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="tqa-fieldgrid">
            ...
            <div class="tqa-field">
                ...
                <span class="tqa-field__hint">
                    <?php echo $tq_row ? 'اتركها فارغة لإبقاء كلمة المرور الحالية.' : 'ثمانية محارف على الأقل.'; ?>
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="tqa-card tqa-section">
        ...
        <div class="tqa-fieldgrid tqa-fieldgrid--3">
            <?php foreach (array(
                'facebook_link' => array('فيسبوك', 'facebook'),
                'twitter_link'  => array('إكس (تويتر)', 'twitter'),
                'linkedin_link' => array('لينكدإن', 'linkedin'),
    ...
    <div class="tqa-actions">
        ...
        <a class="tqa-btn tqa-btn--ghost" href="<?php echo $tq_back; ?>">إلغاء</a>
    </div>
</form>
