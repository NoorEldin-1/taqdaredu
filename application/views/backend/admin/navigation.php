...
$tqa_nav = [
    ...
    [t('التواصل'), 'chat', [
        ...
        /* TQ-PUSH — إشعارات التطبيق: مرآة «داخل المنصة» على الجوال. */
        ['tqa_push',         t('إشعارات التطبيق'),    'taqdar_admin/push',        'bell',  null],
        /* TQ-LRS — مستودع سجلات التعلم الوطني: قناة صادرة كالبريد
           وواتساب، وموضعها معهما. ومن يضبط الإشعارات هو من يضبطه. */
        ['tqa_lrs',          t('مستودع سجلات التعلم'), 'taqdar_admin/lrs',        'send', null],
        /* و«اختبار التحقق» بجواره: هو ما يفتح بيئة الإنتاج عند الجهة. */
        ['tqa_lrs_verify',   t('اختبار التحقق'),       'taqdar_admin/lrs_verify', 'check-badge', null],
    ]],
