		...
		<form class="ajaxForm" action="<?= site_url('admin/course_actions/add_shortcut'); ?>">
			...
			<?php if(addon_status('scorm_course') || addon_status('h5p')): ?>
                <div class="tqa-field">
                  ...
                  <select class="tqa-select" name="course_type" id="course_type">
			...
			<div class="tqa-field">
				...
				<input type="text" name="title" class="tqa-input" placeholder="<?php echo get_phrase('enter_course_title'); ?>">
			</div>

			<div class="tqa-field">
				<label><?php echo get_phrase('category'); ?> <span class="required">*</span></label>
				<select class="tqa-select" name="sub_category_id" id="sub_category_id" required>
	            ...
	            <small class="tqa-field__hint"><?php echo get_phrase('select_sub_category'); ?></small>
			</div>

			<div class="tqa-field">
                <label for="level"><?php echo get_phrase('level'); ?></label>
                <select class="tqa-select" name="level" id="level">
			...
			<div class="tqa-field">
                ...
                <select class="tqa-select" name="language_made_in" id="language_made_in">
            ...
            <div class="paid-course-stuffs">
                <div class="tqa-field">
                    ...
                    <input type="number" class="tqa-input" id="price_s" name = "price" placeholder="<?php echo get_phrase('enter_course_course_price'); ?>" min="0">
                </div>
                ...
                <div class="tqa-field">
                    ...
                    <input type="number" class="tqa-input" name="discounted_price" id="discounted_price" onkeyup="calculateDiscountPercentage(this.value)" min="0">
                    <small class="tqa-field__hint"><?php echo get_phrase('this_course_has'); ?> <span id = "discounted_percentage_s" class="text-danger">0%</span> <?php echo get_phrase('discount'); ?></small>
                </div>
            </div>
            ...
            <div class="tqa-field" id="number_of_monthShortcut" style="display: none">
                <label><?php echo get_phrase('Number of month'); ?></label>
                <input class="tqa-input" type="number" name="number_of_monthShortcut" min="1">
                <small class="tqa-badge tqa-badge--muted"><?php echo get_phrase('After purchase, students can access the course until your selected time.'); ?></small>
            </div>

            <div class="tqa-field">
                <button class="tqa-btn tqa-btn--primary"><?php echo get_phrase('add_course'); ?></button>
            </div>
		</form>
	</div>
</div>
