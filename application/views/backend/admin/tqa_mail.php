        ...
        <div class="tqa-card">
            ...
            <div>
                ...
                $tq_deps = array(
                    ...
                    array('نتيجة تحديد المستوى',     'لا تخرج من شاشة الطالب، ولا يعلم بها وليه',  false),
                ...
                <p class="tqa-hint">
                    ...
                    وخارجه <strong>نتيجة تحديد المستوى</strong>: ترسل ما دام البريد
                    مضبوطا — لأن على هذه النتيجة يقرر ولي الأمر أي باقة يشتري،
                    ورسالة تصله بعد أن يدفع لا تفيده.
                </p>
