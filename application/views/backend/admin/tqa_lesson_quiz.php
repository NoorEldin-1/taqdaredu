...
<?php tqa_head(t('اختبار الدرس'), $L['title'], 'help',
    ($tq_course
...
<div class="tqa-card tqa-section">
    <div class="tqa-card__head"><h4 class="header-title"><?php echo t('ما الذي يفعله هذا الاختبار'); ?></h4></div>
    <div class="tqa-card__body">
        ...
        <div class="tqz-gate">
            ...
            <div class="tqz-gate__c">
                ...
                <span class="tqz-gate__l"><?php echo t('حد النجاح'); ?></span>
            </div>
            <div class="tqz-gate__c">
            ...
            <div class="tqz-gate__c">
                ...
                <span class="tqz-gate__l"><?php echo t('محاولة مسلمة'); ?></span>
            </div>
        </div>
            ...
            <div class="tqa-note<?php echo $tq_ready['ok'] ? '' : ' tqa-note--warn'; ?>">
                ...
                <span>
                    <strong><?php echo $tq_ready['ok']
                        ...
                        : t('هذا الاختبار لا يعمل بعد:'); ?></strong>
...
<?php /* ── الإعدادات ─────────────────────────────────────────────── */ ?>
<div class="tqa-card tqa-section">
    <div class="tqa-card__head"><h4 class="header-title"><?php echo t('إعدادات الاختبار'); ?></h4></div>
    <div class="tqa-card__body">
        <form method="post" action="<?php echo site_url('taqdar_admin/lesson_quiz_settings/' . $lid); ?>">
            ...
            <div class="tqa-fieldgrid">
                <div class="tqa-field">
                    <label class="tqa-field__label" for="qz_pass"><?php echo t('حد النجاح'); ?></label>
                ...
                <div class="tqa-field">
                    <label class="tqa-field__label" for="qz_secs"><?php echo t('الحد الزمني (ثوان)'); ?></label>
                    <input class="tqa-input" type="number" id="qz_secs" name="time_limit_sec"
                           min="0" step="30" value="<?php echo $tq_secs; ?>">
                    <span class="tqa-field__hint"><?php echo t('صفر = بلا حد. والضغط الزمني يقيس السرعة لا الفهم.'); ?></span>
                </div>
            </div>
...
<div class="tqa-card tqa-section">
    <div class="tqa-card__head"><h4 class="header-title"><?php echo t('أداء الطلاب في كل سؤال'); ?></h4></div>
    <div class="tqa-card__body">
...
<?php if ($tq_att): ?>
<div class="tqa-card">
    <div class="tqa-card__head"><h4 class="header-title"><?php echo t('من أدى هذا الاختبار'); ?></h4></div>
    <div class="tqa-card__body">
        <p class="tqa-dim" style="margin-block-end:var(--tq-space-m)">
