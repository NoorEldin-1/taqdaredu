...
/**
 * نظرة عامّة على الربط — بالدورة لا بالدرس.
 *
 ...
 * تُحسَب الأرقام هنا وإليها يقود زرّ الربط.
 */
?>
...
<div class="tqa-head">
    <div>
        ...
        <p>الدورات مرتّبة بالأكثر نقصًا أوّلًا — ابدأ من أعلى القائمة.</p>
    </div>
</div>
...
<div class="tqa-note">
    <strong>السؤال المربوط بهدف هو وحده ما تراه بوّابة الإتقان.</strong>
    فالمحرّك يقرأ: سؤال ← هدف ← درس الفيديو. ودورةٌ بلا سؤال مربوط لا يُنشَأ
    فيها تقييم مراجعة أصلًا، فينحدر شرط الفتح إلى المشاهدة وحدها ويصير القفل
    ...
    <div class="card-body">
        <?php if (empty($courses)): ?>
            ...
            <div class="tqa-empty">
                ...
                <p>أضِف دورةً ودروسها واختباراتها، ثم أهدافًا لدروس الفيديو، ثم عُد إلى هنا.</p>
            </div>
        ...
        <?php else: ?>
                            ...
                            <td>
                                <?php if ($o === 0): ?>
                                    <a class="btn btn-sm btn-secondary"
                                       href="<?php echo site_url('taqdar_admin/form/objectives'); ?>">أضِف أهدافًا</a>
                                <?php elseif ($t === 0): ?>
                                    <span class="tqa-dim">لا أسئلة تُربَط</span>
                                <?php else: ?>
            ...
            <p class="tqa-count">
                «المربوط» يُحسَب بشرط المحرّك نفسه: سؤالٌ يشير إلى هدف قائم في
                إحدى دروس هذه الدورة. أمّا سؤال يشير إلى هدف محذوف أو إلى هدف في
                دورة أخرى فلا يُعَدّ مربوطًا — لأن البوّابة لا تجده.
            </p>
