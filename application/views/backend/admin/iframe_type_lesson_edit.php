...
<div class="tqa-field">
    <label class="tqa-field__label" for="iframe_source">
        <?php echo t('كود التضمين أو رابطه'); ?> <span class="tqa-field__req" aria-hidden="true">*</span>
    </label>
    ...
    <span class="tqa-field__hint">
        <?php echo t('يقبل وسم'); ?> <span class="tq-ltr" dir="ltr">&lt;iframe&gt;</span> <?php echo t('كاملا، أو الرابط وحده.'); ?>
    </span>
</div>
