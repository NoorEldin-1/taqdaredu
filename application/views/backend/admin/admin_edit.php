...
<form action="<?php echo site_url('admin/admins/edit/' . $tq_id); ?>" enctype="multipart/form-data" method="post"
    ...
    <div class="tqa-card tqa-section">
        ...
        <div class="tqa-fieldgrid">
            ...
            <div class="tqa-field tqa-field--full">
                ...
                <div class="tqa-tags" data-tqa-tags>
                    ...
                    <input class="tqa-tags__in" type="text" id="skills_in"
                           placeholder="<?php echo te('اكتب مهارة ثم اضغط Enter'); ?>" autocomplete="off" data-tqa-tags-input>
                </div>
                <span class="tqa-field__hint"><?php echo t('تفصل بفواصل. اضغط Enter بعد كل واحدة.'); ?></span>
            </div>
            ...
            <div class="tqa-field tqa-field--full">
                ...
                <div class="tqa-file">
                    <img class="tqa-avatar" src="<?php echo html_escape($tq_photo); ?>" alt="<?php echo te('الصورة الحالية'); ?>"
                         width="38" height="38">
    ...
    <div class="tqa-card tqa-section">
        ...
        <div class="tqa-fieldgrid">
            ...
            <div class="tqa-field">
                <label class="tqa-field__label" for="password"><?php echo t('كلمة مرور جديدة'); ?></label>
                <input class="tqa-input tqa-input--ltr" type="password" id="password" name="password" dir="ltr"
                       minlength="8" autocomplete="new-password">
                <span class="tqa-field__hint"><?php echo t('اتركها فارغة لإبقاء كلمة المرور الحالية.'); ?></span>
            </div>
        </div>
    </div>
