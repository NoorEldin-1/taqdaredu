...
if (!$blog_category) {
    ...
    tqa_empty('لا قسم بهذا المعرف', 'قد يكون حذف من شاشة أخرى.',
        'كل الأقسام', site_url('admin/blog_category'), 'grid');
    echo '</div>';
    return;
}
?>

<?php tqa_head('تعديل قسم المدونة', $blog_category['title'], 'grid',
...
<form class="tqa-card" method="post" style="max-inline-size:640px"
    ...
    <div class="tqa-field">
        ...
        <span class="tqa-field__hint">ثمانون محرفا فأقل.</span>
    </div>
