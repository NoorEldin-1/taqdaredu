...
class Taqdar_lang extends CI_Controller
{
    ...
    public function set()
    {
        ...
        /* الكعكة: الجلسة تنتهي بإغلاق المتصفح، والتفضيل لا ينبغي أن ينتهي
           معها. سنة كاملة، ومسارها الجذر.

           وهي تقرأ على سطح اللوحة وحده (TQ-I18N-SURFACE): المبدل لا يوجد
           في ترويسة الموقع العام، فلا معنى لأن يقلب لغته. */
