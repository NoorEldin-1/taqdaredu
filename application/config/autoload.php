...
*/
$autoload['helper'] = array('url','file','form','security','string','inflector','directory','download','user','multi_language', 'common', 'pagination', 'addon', 'taqdar', 'taqdar_icons', 'taqdar_role', 'taqdar_admin', 'taqdar_site');
