...
class Taqdar_catalog_model extends CI_Model
{
    ...
    public static $KINDS = array(
        ...
        'guide'    => 'دليل المعلم',
        /* TQ-SUM-DRIVE — الملخّصات والعروض: مادّة مراجعة لا كتابًا
           مقرَّرًا، ومرشّح الأنواع في صفحة الصفّ يفرزها بنفسه فلا
           تختلط بالمقرَّر على من جاء يبحث عن كتابه. */
        'summary'  => 'ملخّصات ومراجعات',
        'slides'   => 'عروض تقديمية',
    );
