    ...
    public function registry($page = null)
    {
        $pages = array(
            ...
            'site_books' => array(
                ...
                'route'  => 'books',
                'icon'   => 'book',
                'lead'   => 'رأس صفحة كتب المنهج — والكتب نفسها تحرر من شاشة «الكتب».',
                'fields' => array(
                    'hero_title' => array('label' => 'العنوان', 'type' => 'line', 'default' => 'كتب المنهج الدراسي'),
                    'hero_sub'   => array('label' => 'السطر تحت العنوان', 'type' => 'line',
                                          'default' => 'تصفح وحمل مجانا'),
                    'hero_lede'  => array('label' => 'نص التعريف', 'type' => 'text',
                                          'default' => 'كتب المنهج السعودي المعتمد، مرتبة حسب المرحلة والمادة، جاهزة للتصفح والتحميل في أي وقت.'),
                ),
            ),
            ...
            'plans' => array(
                ...
                'route'  => 'plans',
                'icon'   => 'card',
                'lead'   => 'رأس صفحة الاشتراكات — وأسعار الباقات تحرر من شاشة «الباقات».',
                'fields' => array(
