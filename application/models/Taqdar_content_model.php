 ...
 *
 * ثمان صفحات عامة منشورة (`home` · `site_students` · `site_teachers` ·
 * `site_parents` · `site_books` · `plans` · `about_us` · `contact_us`)
 * كانت نصوصها كلها مكتوبة في القوالب: العنوان الرئيسي،
    ...
    public function registry($page = null)
    {
        $pages = array(
            ...
            'site_catalog' => array(
                ...
                'route'  => 'catalog',
                'icon'   => 'book',
                'lead'   => 'رأس الكتالوج الموحد — والمحتوى نفسه يحرر من شاشات «البرامج» و«الكتب» و«الباقات».',
                'fields' => array(
                    'hero_title' => array('label' => 'العنوان', 'type' => 'line',
                                          'default' => 'المواد والبرامج التعليمية'),
                    'hero_lede'  => array('label' => 'نص التعريف', 'type' => 'text',
                                          'default' => 'كل ما تقدمه تقدر في مكان واحد: باقات المراحل وبرامج المواد وكتب المنهج — ابحث ورشح حتى تصل إلى ما يخص صفك.'),
                ),
            ),
            ...
            /* صفحة الباقة الواحدة — `plan/{code}`. وحقلها الوحيد اليوم
               هو الفيديو التعريفي فوق السعر: **مقطع واحد للمنصة كلها**
               لا يخص مادة ولا صفا ولا معلما. وكان موضعه يعرض أول درس
               مجاني في الباقة، فيقرأ برومو وهو درس. */
            /* TQ-FOUNDATION-BAND — رأس الصفحة العامة، ورأس قسم «مسارات
               التأسيس» الذي يطبع في الرئيسية وصفحة الباقات معا. والمسارات
               نفسها — اسمها وسعرها ومخرجاتها — تحرر من «مسارات التأسيس». */
            'foundation' => array(
                'title'  => 'قسم التأسيس',
                'route'  => 'foundation',
                'icon'   => 'graduation',
                'lead'   => 'رأس صفحة التأسيس، ورأس قسم «مسارات التأسيس» في الرئيسية وصفحة الباقات.',
                'fields' => array(
                    'hero_title'   => array('label' => 'صفحة التأسيس — العنوان', 'type' => 'line',
                                            'default' => 'قسم التأسيس'),
                    'hero_lede'    => array('label' => 'صفحة التأسيس — نص التعريف', 'type' => 'text',
                                            'default' => 'حصص مباشرة فردية مع معلم متخصص، تبدأ من حيث الطالب لا من حيث صفه. تأسيس في اللغة العربية والإنجليزية والرياضيات — بلا منهج صف، وبلا اشتراك: تحجز الساعة وتدفع ثمنها وحدها.'),
                    'band_eyebrow' => array('label' => 'قسم الرئيسية والباقات — السطر الذهبي', 'type' => 'label',
                                            'default' => 'قسم مستقل عن الباقات'),
                    'band_title'   => array('label' => 'قسم الرئيسية والباقات — العنوان', 'type' => 'line',
                                            'default' => 'مسارات التأسيس'),
                    'band_lede'    => array('label' => 'قسم الرئيسية والباقات — نص التعريف', 'type' => 'text',
                                            'default' => 'حصص فردية مباشرة مع معلم متخصص، تبدأ من مستوى الطالب لا من صفه — بلا اشتراك: تحجز الحصة وتدفع ثمنها وحدها.'),
                ),
            ),

            'plan_detail' => array(
                'title'  => 'صفحة الباقة الواحدة',
                'route'  => 'plan/basic-primary',
                'icon'   => 'card',
                'lead'   => 'الفيديو التعريفي فوق السعر — واحد لكل الباقات والصفوف.',
                'fields' => array(
                    'promo_video' => array(
                        'label'   => 'رابط الفيديو التعريفي',
                        'type'    => 'line',
                        'default' => '',
                        'hint'    => 'رابط فيميو أو يوتيوب أو ملف mp4. يظهر فوق السعر في كل صفحات الباقات، وهو واحد لجميع المراحل والمواد. والفارغ يعني صورة بلا علامة تشغيل — ومعاينة الدرس تبقى في المنهج أسفل الصفحة.',
                    ),
                    'promo_label' => array(
                        'label'   => 'تسمية زر الفيديو',
                        'type'    => 'label',
                        'default' => 'فيديو تعريفي',
                    ),
                ),
            ),
